			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="${pageContext.request.contextPath}/after/order.jsp">订单管理</a></li>
			...
			<form class="form-inline" action="${pageContext.request.contextPath}/user/list" method="post">
				<div class="col-md-4">
					<div class="form-group">
						<label for="exampleInputName2">订单号</label> <input type="text" class="form-control" id="exampleInputName2"
			...
			<form id="deleteFrom" action="${pageContext.request.contextPath}/admin/delect" method="post">
				<table style="text-align: center;margin-right:10px;width:99%" class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							<td style="align-items: center;"><input type="checkbox" class="checkAll"/></td>
							<td>${obj.count}</td>
							<td>${user.username}</td>
							<td>${user.phone}</td>
							<td>${user.mail}</td>
							<td>¥ <span style="color: orangered;">888.00</span> 元</td>
							<td>
								<a href="#"><span class="glyphicon glyphicon-edit" color="#5BC0DE"></span></a>
								<a class="glyphicon glyphicon-trash" color="#5BC0DE" style="text-decoration:none" onclick="deleteConfirm(${user.id},'${user.username}')"></a>
							</td>
