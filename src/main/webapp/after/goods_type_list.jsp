				...
				<table style="text-align: center;margin-right:10px;width:99%" class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><a><span class="glyphicon glyphicon-edit" color="#5BC0DE" onclick="showEdit(${goodsType.id},'${goodsType.typename}')"></span></a></td>
							<td><a class="glyphicon glyphicon-trash" color="#5BC0DE" style="text-decoration:none" onclick="deleteConfirm(${goodsType.id},'${goodsType.typename}')"></a></td>
